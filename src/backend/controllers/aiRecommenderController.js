...
const createAiRecommendation = catchAsyncErrors(async (req, res) => {
	const { whatAreYouHereFor, workFor, category, subCategory, helpsMeWith, whatsImportant, companySize } = req.body;
...
export { createAiRecommendation, getAiRecommendation, allAiRecommendations, deleteAiRecommendation };
