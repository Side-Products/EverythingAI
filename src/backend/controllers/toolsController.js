...
const allToolsForHomepage = catchAsyncErrors(async (req, res) => {
	...
	const [marketingTools, designTools, developerTools, productivityTools, imagesTools, promptsTools, videoTools, productTools, salesTools] =
...
const updateTool = catchAsyncErrors(async (req, res, next) => {
	...
	const { productHuntLink, productHuntStars, G2Link, G2Stars, everythingAIStars, trustPilotLink, trustPilotStars } = req.body;
