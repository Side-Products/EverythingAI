					...
					<div className="w-full flex flex-wrap items-center justify-between pl-7 sm:pl-9 pr-16 lg:px-16 py-2">
						...
						<div className="hidden lg:block">
							<ul className="flex flex-row items-center font-medium md:text-base md:space-x-3 xl:space-x-10 md:mt-0 sm:text-sm">
								<li
									className={
										"font-semibold block py-2 pl-2 pr-3 text-dark-800 hover:text-dark-200 transition duration-300 " +
										(router.pathname == "/features" ? "text-gradient-primary-tr" : "")
									}
								>
								...
								<li
									className={
										"font-semibold block py-2 pl-2 pr-3 text-dark-800 hover:text-dark-200 transition duration-300 " +
										(router.pathname == "/product" ? "text-gradient-primary-tr" : "")
									}
								>
								...
								<li
									className={
										"font-semibold block py-2 pl-2 pr-3 text-dark-800 hover:text-dark-200 transition duration-300 " +
										(router.pathname == "/testimonials" ? "text-gradient-primary-tr" : "")
									}
								>
								...
								<li
									className={
										"font-semibold block py-2 pl-2 pr-3 text-dark-800 hover:text-dark-200 transition duration-300 " +
										(router.pathname == "/dashboard" ? "text-gradient-primary-tr" : "")
									}
								>
