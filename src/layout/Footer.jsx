			...
			<div className="w-full max-w-[1920px] pt-12 pb-12 px-6 md:px-8 lg:px-16 xl:px-20 2xl:px-20 bg-light-100 border-t border-t-light-400">
				...
				<div className="grid flex-wrap justify-between w-full grid-cols-1 py-8 mt-5 border-t-2 border-gray-100 sm:grid-cols-2 gap-y-10 md:gap-y-0 md:flex font-primary">
						...
						<ul className="space-y-2">
							...
							<li className="text-dark-200 hover:text-primary-500">
								<Link href="/ai-recommender">
									<i className="fa-solid fa-fire-flame-curved mr-1 text-secondary-400"></i> AI Recommender
								</Link>
							</li>
						</ul>
					...
					<div className="flex flex-col space-y-4">
						...
						<ul className="space-y-2">
							<li className="text-dark-200 hover:text-primary-500">
								<Link href="https://everythingai.club/collections/for-creators-influencers" target="_blank" rel="noopener noreferrer">
									Tools for Creators
								</Link>
							</li>
							<li className="text-dark-200 hover:text-primary-500">
								<Link href="https://everythingai.club/collections/for-saas-entrepreneurs" target="_blank" rel="noopener noreferrer">
									SAAS Tools
								</Link>
							</li>
							<li className="text-dark-200 hover:text-primary-500">
								<Link href="https://everythingai.club/blogs/ai-in-marketing-definitive-guide/" target="_blank" rel="noopener noreferrer">
									AI In Marketing
								</Link>
							</li>
							<li className="text-dark-200 hover:text-primary-500">
								<Link href="https://everythingai.club/blogs/top-free-ai-tools/" target="_blank" rel="noopener noreferrer">
									Top Free Tools
								</Link>
							</li>
							<li className="text-dark-200 hover:text-primary-500">
								<Link href="https://everythingai.club/blogs/ai-tools-for-productivity/" target="_blank" rel="noopener noreferrer">
