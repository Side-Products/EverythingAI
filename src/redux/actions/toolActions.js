...
export const getAllToolsServerSide = (req, type, query) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${origin}/api/tools?page=${query?.page}`,
      {
        params: params,
...
export const adminGetAllVerifiedToolsServerSide = (req) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${origin}/api/admin/tools/verified`,
      config
    );
...
export const adminGetAllVerifiedTools = (currentPage) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `/api/admin/tools/verified?page=${currentPage}`
    );
...
export const adminGetAllUnverifiedToolsServerSide =
  (req) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(
        `${origin}/api/admin/tools/unverified`,
        config
      );
...
export const adminGetAllUnverifiedTools = (currentPage) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `/api/admin/tools/unverified?page=${currentPage}`
    );
