				...
				<div className="flex flex-col gap-y-6">
					...
					{toolToEdit && session?.user?.role === "admin" && (
						<div className="flex flex-col p-10 bg-light-100 rounded-2xl">
							...
							<div className="flex flex-col gap-y-8">
								...
								/>
								{/* Term Details */}
								<PurchaseTermInput purchaseTerms={purchaseTerms} setPurchaseTerms={setPurchaseTerms} />
					...
					{!toolToEdit && (
						<div className="flex flex-col p-10 bg-light-100 rounded-2xl">
							...
							<div className="mb-6 text-md font-light ">*Create and submit a tool first in order to add Ecommerce </div>
						</div>
					)}
				</div>
			</div>
