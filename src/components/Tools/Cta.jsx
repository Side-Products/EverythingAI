  ...
  return (
    <div className="flex flex-col items-center justify-center text-center bg-gradient-tertiary-r sm:py-16 sm:px-16 lg:px-32 px-6 py-8 rounded-3xl">
      ...
      <p className="mt-10 text-light-300 text-xl sm:text-3xl tracking-[-0.5px]">
        Supercharge your workflows and accelerate your productivity!
      </p>
      <p className="mt-4 text-light-300 text-md sm:text-3xl tracking-[-0.5px]">
        Save time to do things that matter 🕔⚡️
      </p>

      <div className="w-3/4 sm:w-1/3 md:w-1/3 xl:w-1/4 mt-12">
        <Link
          href={tool?.utmLink || tool?.url || "https://everythingai.club"}
          target="_blank"
        ...
        >
          <Button
            ...
            variant={"classic"}
            rounded={true}
            classes="text-lg rounded-full px-8 py-3 shadow-2xl relative group/link-btn"
          >
            Try it out now
