...
export default function Cta({ tool }) {
	return (
		<div className="flex flex-col items-center justify-center text-center bg-gradient-tertiary-r sm:py-16 sm:px-16 lg:px-32 px-6 py-8 rounded-3xl">
			<span className="text-4xl sm:text-6xl font-bold tracking-[-2px] sm:tracking-[-2.5px] text-light-100">Check out {tool?.name}</span>
			<p className="mt-10 text-light-300 text-xl sm:text-3xl tracking-[-0.5px]">Supercharge your workflows and accelerate your productivity!</p>
			<p className="mt-4 text-light-300 text-md sm:text-3xl tracking-[-0.5px]">Save time to do things that matter 🕔⚡️</p>

			<div className="w-2/3 sm:w-1/3 md:w-1/3 xl:w-1/4 mt-12">
