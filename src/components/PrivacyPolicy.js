  ...
  return (
    <div className="w-full flex flex-col justify-center items-center pb-20 text-light-400">
      <div className="w-full relative text-base max-w-[1500px] text-dark-700">
        ...
        <div className="font-semibold text-gradient-primary-tr leading-[30px] text-[1.2em] mt-12">
          This Privacy Policy applies to Everythingai.club
        </div>
        <div className="mt-5 font-secondary text-[1em] tracking-[0.5px]">
          Everythingai.club recognises the importance of maintaining your
          ...
          Everythingai.club is a property of Masterlife University Private
          Limited, an Indian Company registered under the Companies Act, 2013
          having its registered office at 130,SFS-208, Yelahanka New Town,
          Opposite Mother dairy, Bangalore – 560064
        </div>

        <div className="font-semibold text-gradient-primary-tr leading-[30px] text-[1.6em] mt-12">
        ...
        <div className="mt-4 font-secondary text-[1em] tracking-[0.5px] flex flex-col gap-y-5">
          <p>
            ...
            mobile number, phone number, street, city, state, pincode, country
            and ip address.
          </p>
          <p>
            <b>Payment and billing information.</b> We might collect your
            billing name, billing address and payment method when you buy a
            subscription. We NEVER collect your credit card number or credit
            card expiry date or other details pertaining to your credit card on
            our website. Credit card information will be obtained and processed
            by our online payment partner.
          </p>
          <p>
            <b>Information you post.</b> We collect information you post in a
          ...
          <p>
            ...
            information about you, tools you like, save or any other information
            provided by your during the use of our website. We might collect
        ...
        <div className="mt-4 font-secondary text-[1em] tracking-[0.5px] flex flex-col gap-y-5">
          <p>
            ...
            information directly from you when you register for our newsletter
            or create an account. We also collect information if you post a
            comment on our website or ask us a question through phone or email.
          </p>
          <p>
            <b>We collect information from you passively.</b> We use tracking
            tools like Google Analytics, Google Webmaster, browser cookies and
            web beacons for collecting information about your usage of our
            website.
          </p>
          <p>
            <b>We get information about you from third parties.</b> For example,
            if you use an integrated social media feature on our websites. The
        ...
        <div className="mt-4 font-secondary text-[1em] tracking-[0.5px] flex flex-col gap-y-5">
          <p>
            <b>We use information to contact you:</b> We might use the
          ...
          <p>
            <b>We use information to improve our products and services.</b> We
          ...
          <p>
            <b>We use information for security purposes.</b> We may use
            information to protect our company, our customers, or our websites.
          </p>
          <p>
            <b>We use information for marketing purposes.</b> We might send you
          ...
          <p>
            ...
            We might send you emails or SMS about your account or purchase. We
        ...
        <div className="mt-4 font-secondary text-[1em] tracking-[0.5px] flex flex-col gap-y-5">
          ...
          <p>
            ...
            includes a third party who provide or sponsor an event or content,
            or who operates a venue where we hold events. Our partners use the
        ...
        <div className="mt-4 font-secondary text-[1em] tracking-[0.5px]">
          <p>
            <b>You can opt out of receiving our marketing emails.</b> To stop
            receiving our promotional emails, please email {contact_email}. It
        ...
        <div className="mt-4 font-secondary text-[1em] tracking-[0.5px]">
          ...
          Mr. Anirudh Narayan
          <br />
          130, SFS-208, Yelahanka New Town, Opposite Mother dairy, Bangalore –
          560064
          <br />
          ...
          <a
            ...
            className="font-primary font-semibold text-primary-600"
          >
            {contact_email}
          </a>
        </div>
        ...
        <div className="mt-4 font-secondary text-[1em] tracking-[0.5px]">
          This Privacy Policy was last updated on 24.04.2023. From time to time
