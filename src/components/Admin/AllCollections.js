...
export default function AllCollections() {
  ...
  const { collections, collectionsCount, error, loading } = useSelector(
  ...
  const [isUpdateCollectionModalOpen, setUpdateCollectionModalOpen] =
    useState(false);
  ...
  return loading ? (
    ...
    <div className="grid w-full mt-10 overflow-scroll">
      <div className="flex justify-between w-full">
        ...
        >
          <li
            className="nav-item"
            role="presentation"
            onClick={() => setActiveTable("allCollectionsTable")}
          >
            <span
              className={
      ...
      <div className="tab-content" id="tabs-tabContent3">
        ...
        {activeTable == "allCollectionsTable" && (
          <div
            ...
            id="tabs-all-collections"
            role="tabpanel"
            aria-labelledby="tabs-all-collections-details"
          >
                    ...
                    <tr className="bg-light-100 text-dark-700" key={index}>
                      <td className="p-3">
                        <span className="flex align-items-center">
                          <span className="ml-3">
                            <span className="">
                              {getTimestamp(collection.createdAt).slice(0, 19)}
                            </span>
                          </span>
                        </span>
                      </td>
      ...
      <UpdateCollectionModal
        ...
        setOpen={setUpdateCollectionModalOpen}
