...
export default function AllTools({
  ...
  return loading ? (
    ...
    <div className="grid w-full mt-10 overflow-scroll">
      ...
      <div className="tab-content" id="tabs-tabContent3">
        ...
        {activeTable == "allToolsTable" && (
          <div
            ...
            id="tabs-all-tools"
            role="tabpanel"
            aria-labelledby="tabs-all-tools-details"
          >
                    ...
                    <tr className="bg-light-100 text-dark-700" key={index}>
                      <td className="p-3">
                        <span className="flex align-items-center">
                          <span className="ml-3">
                            <span className="">
                              {getTimestamp(tool.createdAt).slice(0, 19)}
                            </span>
                          </span>
                        </span>
                      </td>
                      ...
                      <td className="p-3">
                        {tool.subCategory ? tool.subCategory?.name : "-"}
                      </td>
        ...
        {activeTable == "unverifiedTable" && (
          <div
            ...
            id="tabs-unverified"
            role="tabpanel"
            aria-labelledby="tabs-unverified-table"
          >
        ...
        {activeTable == "verifiedTable" && (
          <div
            className="tab-pane fade"
            id="tabs-verified-tools"
            role="tabpanel"
            aria-labelledby="tabs-verified-tools-table"
          >
                    ...
                    <tr className="bg-light-100 text-dark-700" key={index}>
                      ...
                      <td
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          router.push(
                            `/admin/tools/edit/${tool._id}?feature=true`
                          );
                        }}
                      >
                        Feature
      ...
      <DeleteToolConfirmModal
        isOpen={isDeleteToolModalOpen}
        setOpen={setDeleteToolModalOpen}
        toolToDelete={toolToDelete}
      />
      <VerifyToolConfirmModal
        isOpen={isVerifyToolModalOpen}
        setOpen={setVerifyToolModalOpen}
        toolToVerify={toolToVerify}
      />
      <UnverifyToolConfirmModal
        isOpen={isUnverifyToolModalOpen}
        setOpen={setUnverifyToolModalOpen}
        toolToUnverify={toolToUnverify}
      />
    </div>
  );
}
