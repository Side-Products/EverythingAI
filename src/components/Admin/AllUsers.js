...
export default function AllUsers() {
  ...
  const { users, usersCount, admins, maintainerUsers, error, loading } =
      ...
      <div className="flex justify-between w-full">
        ...
        >
          <li
            className="nav-item"
            role="presentation"
            onClick={() => setActiveTable("allUsersTable")}
          >
            <span
              className={
          ...
          <li
            className="nav-item"
            role="presentation"
            onClick={() => setActiveTable("adminsTable")}
          >
            <span
              className={
          ...
          <li
            className="nav-item"
            role="presentation"
            onClick={() => setActiveTable("maintainerUsersTable")}
          >
            <span
              className={
                "cursor-pointer nav-link w-full block font-medium text-xs leading-tight border-x-0 border-t-0 border-b-2 border-transparent px-6 py-3 my-2 hover:bg-primary-200 transition duration-300 rounded-t " +
      ...
      <div className="tab-content" id="tabs-tabContent3">
        ...
        {activeTable == "allUsersTable" && (
          <div
            ...
            id="tabs-all-users"
            role="tabpanel"
            aria-labelledby="tabs-all-users-details"
          >
            {users.length !== 0 ? (
              <table className="w-full table allUsers-table table-auto text-gray-400 border-separate space-y-6 text-sm">
                <thead className="bg-dark-800">
                  <tr>
                    ...
                    <th className="p-3 text-left text-light-200">
                      Delete User
                    </th>
                  </tr>
                </thead>
                    ...
                    <tr className="bg-light-100 text-dark-700" key={index}>
                      <td className="p-3">
                        <span className="flex align-items-center">
                          <span className="ml-3">
                            <span className="">
                              {getTimestamp(user.createdAt).slice(0, 19)}
                            </span>
                          </span>
                        </span>
                      </td>
                      ...
                      <td className="p-3">
                        ...
                        <i
                          className="far fa-copy ml-1 cursor-pointer"
        ...
        {activeTable == "adminsTable" && (
          <div
            ...
            id="tabs-admins"
            role="tabpanel"
            aria-labelledby="tabs-admins-table"
          >
            {admins.length !== 0 ? (
              <table className="w-full table allUsers-table table-auto text-gray-400 border-separate space-y-6 text-sm">
                <thead className="bg-dark-800">
                    ...
                    <tr className="bg-light-100 text-dark-700" key={index}>
                      <td className="p-3">
                        <span className="flex align-items-center">
                          <span className="ml-3">
                            <span className="">
                              {getTimestamp(admin.createdAt).slice(0, 19)}
                            </span>
                          </span>
                        </span>
                      </td>
        ...
        {activeTable == "maintainerUsersTable" && (
          <div
            className="tab-pane fade"
            id="tabs-all-access-users"
            role="tabpanel"
            aria-labelledby="tabs-all-access-users-table"
          >
                    ...
                    <tr className="bg-light-100 text-dark-700" key={index}>
                      <td className="p-3">
                        <span className="flex align-items-center">
                          <span className="ml-3">
                            <span className="">
                              {getTimestamp(maintainerUser.createdAt).slice(
                                0,
                                19
                              )}
                            </span>
                      ...
                      <td className="p-3">
                        <span data-info={maintainerUser._id}>
                          {maintainerUser._id}
                        </span>
                      </td>
                      <td className="p-3">{maintainerUser.name}</td>
                      <td className="p-3">
                        <span data-info={maintainerUser.email}>
                          {maintainerUser.email}
                        </span>{" "}
                        <i
                          className="far fa-copy ml-1 cursor-pointer"
                          onClick={copyToClipboard}
