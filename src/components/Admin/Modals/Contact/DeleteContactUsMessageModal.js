...
const DeleteContactUsMessageModal = ({ isOpen, setOpen, messageToDelete }) => {
  ...
  const { error, isDeleted, loading } = useSelector(
    (state) => state.adminDeleteContactUsMessage
  );
          ...
          >
            <div className="flex flex-col justify-center">
              <div className="flex justify-center items-center gap-x-4">
                <p className="text-xl font-semibold text-dark-300">
              ...
              <div className="text-start text-base mt-4">
                <span className="font-medium text-gradient-primary-tr">
                  Subject
                </span>
              ...
              <div className="text-start text-base mt-4">
                ...
                &nbsp;
                <p className="text-dark-600 pr-2 max-h-[400px] overflow-scroll">
