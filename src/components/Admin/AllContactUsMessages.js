...
export default function AllContactUsMessages() {
  ...
  const { contactUsMessages, error, loading } = useSelector(
    (state) => state.adminGetContactUsMessages
  );
  ...
  const [
    isDeleteContactUsMessageModalOpen,
    setDeleteContactUsMessageModalOpen,
  ] = useState(false);
    ...
    <div className="grid w-full mt-10 overflow-scroll">
      ...
      >
        <li
          className="nav-item"
          role="presentation"
          onClick={() => setActiveTable("allContactUsMessagesTable")}
        >
          <span
            className={
                    ...
                    <tr className="bg-light-100 text-dark-700" key={index}>
                      <td className="p-3">
                        <span className="flex align-items-center">
                          <span className="ml-3">
                            <span className="">
                              {getTimestamp(message.createdAt).slice(0, 19)}
                            </span>
                          </span>
                        </span>
                      </td>
