...
export default function Dropdown({
  ...
  return (
    <div
      className={"flex flex-col items-start justify-start w-full " + classes}
    >
      {label && (
      ...
      <div className="w-full border border-[#D1D5DB] rounded-md">
        ...
        >
          {defaultOption && (
            <option className="text-light-200">{defaultOption}</option>
          )}
            ...
            return (
              ...
              >
                <>
                  ...
                  {name == "pricing" && option.meta && <>({option.meta})</>}
                </>
              </option>
            );
          })}
