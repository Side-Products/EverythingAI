...
export default function MultiDropdown({ options, selectedValue, setSelectedValue, placeholder, type, styledButton = false }) {
	const stylesDropdown = {
		...
		control: (base, state) => ({
			...
			fontSize: "0.9rem",
			fontWeight: "500",
			background: styledButton ? "#fff" : "transparent",
			cursor: "pointer !important",
			borderWidth: 0,
			outline: "none",
			boxShadow: styledButton ? "0px 1px 3px #8f57ff" : state.isFocused ? null : null,
		}),
		//Dropdown Indicators
