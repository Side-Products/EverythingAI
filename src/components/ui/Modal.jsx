      ...
      <Transition show={isModalOpen}>
        ...
        >
          <div
            ...
            className="w-screen h-screen left-0 top-0 bg-black/40 backdrop-blur-sm fixed"
          />
        </Transition.Child>
        <Transition.Child
          as={Fragment}
        ...
        >
          <div
            style={{ zIndex: "60" }}
            className="flex left-0 top-0 justify-center items-center h-full w-full fixed"
          >
            <div
              className={`sm:w-full w-11/12 p-4 bg-light-200 rounded-lg ${
                classes ? classes : "max-w-[32rem]"
              }`}
            >
              ...
              <div
                className={`w-full flex flex-col mb-4 ${
                  titleClasses ? titleClasses : "justify-between items-center"
                }`}
              >
                {image}
                <div className="font-medium text-xl text-center">{title}</div>
              </div>
              <div className="text-sm pt-6 pb-4 px-2 sm:px-8 text-center">
                {content}
              </div>
