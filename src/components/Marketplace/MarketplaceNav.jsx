...
export default function MarketplaceNav({
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-[400px] bg-dark-900 text-light-100">
      ...
      <p className="px-8 mt-4 text-xs text-center sm:my-2 sm:text-sm">
        Discover AI tools that fit like a glove: handpicked for your industry
        and goals.
      </p>
      <ul className="flex mt-8 space-x-6 text-sm font-semibold md:space-x-12 md:text-base">
        <li
          className={
            (currentSelection === 1
              ? "text-light-100"
              : "text-zinc-400 hover:text-gray-300 ") + " cursor-pointer"
          }
        >
          <Link
            href="/tools"
            className={
              (currentSelection === 1 ? "bg-zinc-800" : "bg-zinc-900") +
              " md:px-5 py-2 px-4 md:py-3 rounded-lg"
            }
          >
            Explore
          </Link>
        ...
        >
          <Link
            href="/tools/trending"
            className={
              (currentSelection === 2 ? "bg-zinc-800" : "bg-zinc-900") +
              " md:px-5 md:py-3 py-2 px-4 rounded-lg"
            }
          >
            Trending
          </Link>
        ...
        >
          <Link
            ...
            className={
              (currentSelection === 3 ? "bg-zinc-800" : "bg-zinc-900") +
              " md:px-5 md:py-3 py-2 px-4 rounded-lg"
            }
          >
            New Tools
