		...
		<>
			<PageWrapper title={post.title} blog={true} description={post.title}>
				<div className="mt-10 mb-1  ">
					<Image loading="lazy" className="w-full rounded-md " src={post?.featuredImage?.node?.mediaItemUrl} width={1920} height={1080} />
				</div>
				<div>
					<Head>
					...
					<main>
						<br />
						<h1 className="text-5xl my-7  font-semibold text-start">{post.title}</h1>
